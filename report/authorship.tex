...
\title{Deep Learing based Authorship Identification}
\author{
Chen Qian \qquad Tianchang He \qquad Rao Zhang\\
...
References \cite{dev} follow \cite{abc} the acknowledgments. Use unnumbered third level heading for
